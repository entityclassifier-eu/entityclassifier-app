                    ...
                    <div>
                        ...
                        <div id="app-control">
                            <form onsubmit="invokeAPI2(this); return false;" method="get" id="parametersForm">
                                ...
                                <button type="submit" class="ga-button" form="parametersForm" style="margin-top: 45px;"> Run! </button>
                            </form>
                        </div>
                    </div>
