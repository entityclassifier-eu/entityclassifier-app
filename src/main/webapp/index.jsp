                        ...
                        <div id="app-control">
                            <form onsubmit="invokeAPI(this); return false;" method="get" id="parametersForm">
                                ...
                                <div id="mycheckboxform" style="clear:both; float:left; padding-left: 20px; padding-top: 10px; ">
                                    ...
                                    <div style="float:left;"><input class="provenance" id="Check10" type="checkbox" value="thd" onclick="selectOnlyThisProv(this.id)" checked><span style="border-bottom:1px dashed;"   class="tooltipclass2" title="</br>Types are extracted from the free text of </br>Wikipedia articles.</br></br>">THD</span></input></div>
                                    <div style="float:left; margin-left: 10px;"><input class="provenance" id="Check11" type="checkbox" value="dbpedia" onclick="selectOnlyThisProv(this.id)" checked><span style="border-bottom:1px dashed;" class="tooltipclass2" title="</br><a href='http://dbpedia.org'>DBpedia</a> (v3.8), languages: selected + English</br></br>">DBpedia</span></input></div>
                                ...
                                <div id="mycheckboxform" style="clear:both; float:left; padding-left: 20px; padding-top: 10px;">
                                    ...
                                    <div style="float:left;"><input class="entitytype" id="Check7" type="checkbox" value="ne" onclick="selectOnlyThisNEType(this.id)" checked>Named Entities</input></div>
                                    <div style="float:left; margin-left: 10px;"><input class="entitytype" id="Check8" type="checkbox" value="ce" onclick="selectOnlyThisNEType(this.id)">Common Entities</input></div>
                                    <div style="float:left; margin-left: 10px;"><input class="entitytype" id="Check9" type="checkbox" value="all" onclick="selectOnlyThisNEType(this.id)">All</input></div>
                                </div>
                                <div id="mycheckboxform" style="clear:both; float:left; padding-left: 20px; padding-top: 10px;">
