<%-- 
    Document   : footer
    Created on : Sep 6, 2012, 12:57:57 AM
    ...
    <div id="sub-footer">
        ...
        <div class="sub-footer2">
            <div id="footer-horizontal-2">
                <div id="info-box">
                    <strong>Some more info:</strong>
                    <ul>
                        <li>If you are already using THD then please <a href="http://www.dojchinovski.mk/public/data/ECMLPKDD2013-DojchinovskiK.bib
